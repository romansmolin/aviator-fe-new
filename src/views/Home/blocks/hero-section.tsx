...
const HeroSection = () => {
    return (
        <section className='flex justify-center relative bg-transparent sm:w-full lg:max-w-7xl xl:py-10 xl:max-w-screen-xl m-auto'>
            ...
            <Rocket className='-rotate-45 z-0  top-[50%] -translate-y-[50%] -right-[30px] w-[120px] absolute sm:right-[unset] sm:left-0 md:w-24 lg:w-36 lg:left-8 lg:top-[50%] lg:-translate-y-[50%] xl:w-40' />
            <Target className='z-0 absolute top-[50%] -translate-y-[50%] -left-[30px] w-[100px] sm:top-[50%] sm:left-[unset] sm:w-24 sm:right-0 lg:w-36  lg:bottom-0 lg:right-8 xl:w-40' />
        </section>
    )
}
